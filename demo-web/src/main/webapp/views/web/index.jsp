            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="special_description_img">
                        <img src="<c:url value="/template/web/img/bg-img/special.png"/>" alt="">
                    </div>
                </div>
...
<div class="video-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <!-- Video Area Start -->
                <div class="video-area" style="background-image: url(<c:url value="/template/web/img/bg-img/video.jpg"/>);">
            ...
            <div class="col-12">
                ...
                <div class="app_screenshots_slides owl-carousel">
                    <div class="single-shot">
                        <img src="<c:url value="/template/web/img/scr-img/app-1.jpg"/>" alt="">
                    </div>
                    <div class="single-shot">
                        <img src="<c:url value="/template/web/img/scr-img/app-2.jpg"/>" alt="">
                    </div>
                    <div class="single-shot">
                        <img src="<c:url value="/template/web/img/scr-img/app-3.jpg"/>" alt="">
                    </div>
                    <div class="single-shot">
                        <img src="<c:url value="/template/web/img/scr-img/app-4.jpg"/>" alt="">
                    </div>
                    <div class="single-shot">
                        <img src="<c:url value="/template/web/img/scr-img/app-5.jpg"/>" alt="">
                    </div>
                    <div class="single-shot">
                        <img src="<c:url value="/template/web/img/scr-img/app-3.jpg"/>" alt="">
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-5">
                <div class="slider slider-nav">
                    <div class="client-thumbnail">
                        <img src="<c:url value="/template/web/img/bg-img/client-3.jpg"/>" alt="">
                    </div>
                    <div class="client-thumbnail">
                        <img src="<c:url value="/template/web/img/bg-img/client-2.jpg"/>" alt="">
                    </div>
                    <div class="client-thumbnail">
                        <img src="<c:url value="/template/web/img/bg-img/client-1.jpg"/>" alt="">
                    </div>
                    <div class="client-thumbnail">
                        <img src="<c:url value="/template/web/img/bg-img/client-2.jpg"/>" alt="">
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-3">
                <div class="single-team-member">
                    <div class="member-image">
                        <img src="<c:url value="/template/web/img/team-img/team-1.jpg"/>" alt="">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="single-team-member">
                    <div class="member-image">
                        <img src="<c:url value="/template/web/img/team-img/team-2.jpg"/>" alt="">
                        <div class="team-hover-effects">
                            <div class="team-social-icon">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="single-team-member">
                    <div class="member-image">
                        <img src="<c:url value="/template/web/img/team-img/team-3.jpg"/>" alt="">
                        <div class="team-hover-effects">
                            <div class="team-social-icon">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="single-team-member">
                    <div class="member-image">
                        <img src="<c:url value="/template/web/img/team-img/team-4.jpg"/>" alt="">
                        <div class="team-hover-effects">
                            <div class="team-social-icon">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
